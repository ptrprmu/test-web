    ...
    <section className="block px-5 md:hidden ">
      <div className=" flex h-[120px] w-full gap-5 overflow-hidden overflow-x-auto ">
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">Pop</h1>
        </div>
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">Jazz</h1>
        </div>
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">RgB</h1>
        </div>
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">Country</h1>
        </div>
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">Blues</h1>
        </div>
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          <h1 className=" mt-1 text-center text-[14px]">Rock</h1>
        </div>
      </div>
    </section>
  );
